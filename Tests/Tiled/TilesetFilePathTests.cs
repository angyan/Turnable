...
namespace Tests.Tiled
{
    public class TilesetFilePathTests
    {
        ...
        [InlineData(".TSX")]
        [InlineData(".txt")]
        public void Tileset_file_path_cannot_be_constructed_without_specifying_the_correct_extension(string extension)
        {
            // No arrange
        ...
        [InlineData(".json")]
        [InlineData(".JSON")]
        public void Tileset_file_path_can_only_be_constructed_with_supported_file_extensions(string extension)
        {
            // No arrange
