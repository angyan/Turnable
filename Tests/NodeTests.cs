...
public class NodeTests
{
    ...
    [Fact]
    public void Comparing_nodes_at_different_location()
    {
        var node1 = new Node(1, 2);
    ...
    [Fact]
    public void Comparing_to_another_node_at_same_location()
    {
    ...
    [Fact]
    public void Comparing_to_another_node_at_different_location()
    {
        var sut = new Node(1, 2);
    ...
    [Fact]
    public void Neighboring_nodes_at_same_location_are_only_added_once()
    {
        var sut = new Node(1, 2);
    ...
    [Fact]
    public void Hash_code_is_the_same_as_its_locationalculating_a_hash_code()
    {
        var sut = new Node(1, 2);
